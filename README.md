...
- **[openssl-RPM-Builder](https://github.com/philyuchkoff/openssl-RPM-Builder)** [![Stars](https://img.shields.io/github/stars/philyuchkoff/openssl-RPM-Builder?style=flat&color=gold)](https://github.com/philyuchkoff/openssl-RPM-Builder) — Build latest OpenSSL binary for CentOS/RHEL.
- **[slozy-oss](https://github.com/philyuchkoff/slozy-oss)** [![Stars](https://img.shields.io/github/stars/philyuchkoff/slozy-oss?style=flat&color=gold)](https://github.com/philyuchkoff/slozy-oss) — Automated SLO creation for product teams. Full alerting support, OpenSLO YAML format.
...
- **[jodit-footnote-plugin](https://github.com/philyuchkoff/jodit-footnote-plugin)** [![Stars](https://img.shields.io/github/stars/philyuchkoff/jodit-footnote-plugin?style=flat&color=gold)](https://github.com/philyuchkoff/jodit-footnote-plugin) — Plugin for Jodit Editor v4 adding a toolbar button for numbered footnotes.
- **[grafana-backup](https://github.com/philyuchkoff/grafana-backup)** [![Stars](https://img.shields.io/github/stars/philyuchkoff/grafana-backup?style=flat&color=gold)](https://github.com/philyuchkoff/grafana-backup) — Scripts for backup and restore Grafana settings via Grafana API.
...
- **[breezycourses/presage](https://github.com/breezycourses/presage)** [![Stars](https://img.shields.io/github/stars/breezycourses/presage?style=flat&color=gold)](https://github.com/cathrynlavery/diagram-design) — Presage is a Kubernetes autoscaler that uses Google's TimesFM model to forecast what demand will be when new pods are actually ready, rather than reacting to current load.
- **[google-research/timesfm](https://github.com/google-research/timesfm)** [![Stars](https://img.shields.io/github/stars/google-research/timesfm?style=flat&color=gold)](https://github.com/cathrynlavery/diagram-design) — TimesFM (Time Series Foundation Model) is a pretrained foundation model developed by Google Research for time-series forecasting, with its 3.0 version introducing native multivariate forecasting with covariate support and achieving top rankings on major benchmarks.
